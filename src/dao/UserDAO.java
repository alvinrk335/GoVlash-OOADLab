...
/**
 * DAO untuk operasi CRUD User dan Employee
 */
public class UserDAO {
     ...
     * @param userPassword password user
     * @param userGender gender user
     * @param userDOB tanggal lahir
    ...
    /**
     * Ambil semua employee (role != Customer)
     */
